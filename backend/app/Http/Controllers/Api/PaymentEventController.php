...
/**
 * Handles payment event CRUD.
 */
class PaymentEventController extends BaseApiController
{
    protected array $allowedRoles = ['restaurant', 'customer'];
    protected array $allowedStaffRoles = ['manager', 'floor_manager', 'cashier'];
    protected array $mutableStaffRoles = ['manager', 'floor_manager', 'cashier'];
